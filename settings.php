...
$fb_capi_enabled = $conf->get('pixels.fb.capi.enabled',false);
$fb_capi_token = $conf->get('pixels.fb.capi.accesstoken','');
$fb_capi_testcode = $conf->get('pixels.fb.capi.testcode','');
...
$block_spyservices = $conf->get('tds.filters.blocked.spyservices',true);
$block_datacenter = $conf->get('tds.filters.blocked.datacenter',true);
